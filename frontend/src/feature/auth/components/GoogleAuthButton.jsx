...
function GoogleAuthButton() {
  return (
    <a href="/api/auth/google"
      ...
      className="w-full flex items-center justify-center gap-3 rounded-sm border border-[#d7d7d7] bg-white px-6 py-4 text-md font-manrope font-semibold text-[#3c4043] shadow-[0_1px_2px_rgba(60,64,67,0.15)] transition-all duration-300 hover:bg-[#f8f9fa] hover:shadow-[0_1px_3px_rgba(60,64,67,0.2)] active:scale-[0.99] cursor-pointer active:scale-95"
    >
